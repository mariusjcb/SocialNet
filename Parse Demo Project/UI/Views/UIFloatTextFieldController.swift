//
//  UIFloatTextFieldController.swift
//  SUB Chat
//
...
@IBDesignable class UIFloatTextField: UITextField {
    var placeholderDirection: UIPlaceholderDirection = .top
    ...
    private func placeholderAnimateIn() {
        UIView.animate(withDuration: 0.23) {
            ...
            case .top: self.placeholderLabel?.transform = CGAffineTransform.init(translationX: 0, y: -((self.placeholderLabel?.frame.height)! - (self.placeholderLabel?.frame.origin.y)!/3) - 5)
            case .left:
